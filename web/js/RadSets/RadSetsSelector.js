...
var RadSet = (function (window, document, $, undefined) {
    ...
    /**
     ...
     @attribute EntryRelationPreview
     */
    ...
    /**
     Selects a single entry and redraws the chart with the single connection lines
     @method SelectEntry
     @for RadSet
     **/
    _x.SelectEntry = function SelectEntry(entryId) {

        var newSelection = true;
        var selectedRows = $("#tabSelEntities").find(".selected");
        selectedRows.removeClass("selected");

        //there should alwas only be one
        selectedRows.each(function() {
            if($(this).prop("id") == entryId) {
                _x.EntryRelationPreview = null;
                newSelection = false;
            }
        });
        ...
        if(newSelection) {
            _x.EntryRelationPreview = _x.Entries[entryId];
            _x.log("Entry selected: " + _x.EntryRelationPreview.Name);

            $("#tabSelEntities").find("#"+entryId).addClass("selected");
        }
