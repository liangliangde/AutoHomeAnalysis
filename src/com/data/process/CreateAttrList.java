...
//        createAttrList();
    ...
    private static void createStyle_Attr() throws IOException {
        File file = new File("/home/llei/IdeaProjects/autohome/auto_data/styleId_attr.txt");
        InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream(file), "UTF-8");
        BufferedReader bufferedReader = new BufferedReader(inputStreamReader);
        FileOutputStream out = new FileOutputStream("/home/llei/IdeaProjects/autohome/auto_data/styleId_attr_new.csv");
        String lineTxt = null;
    ...
    private static void createAttrList() throws IOException {
        ...
        InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream(file), "UTF-8");
        BufferedReader bufferedReader = new BufferedReader(inputStreamReader);
        FileOutputStream out = new FileOutputStream("/home/llei/IdeaProjects/autohome/auto_data/Attribution.csv");
        String lineTxt = null;
